 ...
 * Use the {@link VendorCatalogueFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class VendorCatalogueFragment extends Fragment {
    ...
    LinearLayout addcatalogueLayout;
    ...
    public VendorCatalogueFragment() {
     ...
     * @return A new instance of fragment VendorCatalogueFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static VendorCatalogueFragment newInstance(String param1, String param2) {
        VendorCatalogueFragment fragment = new VendorCatalogueFragment();
    ...
    private void setUpRecycler()
    {
        ...
        servicesofferAdapter=new servicesOfferedRecyclerAdapter(serviceswholearray,context, VendorCatalogueFragment.this, app);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_vendor_catalogue, container, false);


        servicesofferedrecycler = view.findViewById(R.id.catalogueservicesrecycler);

        addcatalogueLayout = view.findViewById(R.id.createcataloguelayout);
        ...
        addcatalogueLayout.setOnClickListener(v -> {
