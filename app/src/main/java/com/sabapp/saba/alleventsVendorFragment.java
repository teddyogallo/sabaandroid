...
import com.sabapp.saba.adapters.alleventslistRecyclerAdapter;
 ...
 * Use the {@link alleventsVendorFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class alleventsVendorFragment extends Fragment {
    ...
    alleventslistRecyclerAdapter sabaeventsadapter;
     ...
     * @return A new instance of fragment alleventsVendorFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static alleventsVendorFragment newInstance(String param1, String param2) {
        alleventsVendorFragment fragment = new alleventsVendorFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_allevents_vendor, container, false);


        eventlistrecyclerview= view.findViewById(R.id.alleventslistrecycler);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, paymentsendpoint, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Log.e("response", "ALL EVENTS: "+response.toString());
                        hideProgressBar();
                                ...
                                if(message.toLowerCase().matches("success"))
                                {
                                    ...
                                    if(dataobj.length()==0){
                                        ...
                                        for (int i = 0; i < dataobj.length(); i++) {
                                            ...
                                            Log.d("Added Item", event_name + " To all events array list");
                                        }
                                        ...
                                        for ( String singleRecord : event_name)
                                        {
