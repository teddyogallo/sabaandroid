...
import com.sabapp.saba.messaging.initiatemessagecontactlist;
...
public class initiatemessagestartRecycler extends RecyclerView.Adapter<initiatemessagestartRecycler.MyViewHolder>{
    ...
    private initiatemessagecontactlist pulse;

    initiatemessagestartRecycler adapter;
    ...
    public initiatemessagestartRecycler(List<sabaEventItem> bitmapList, Context context, initiatemessagecontactlist pulse) {
    ...
    public initiatemessagestartRecycler(Context context, List<sabaEventItem> bitmapList) {
        this.bitmapList = bitmapList;
        this.context=context;
        this.pulse=pulse;
        this.adapter = this;
    ...
    @Override
    public initiatemessagestartRecycler.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new initiatemessagestartRecycler.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(initiatemessagestartRecycler.MyViewHolder holder, int position) {
