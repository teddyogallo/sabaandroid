...
import com.sabapp.saba.vendorlistFragment;
import com.sabapp.saba.vendors.vendorproposrequest;

import java.util.List;

public class vendorfragmentlistRecycler  extends RecyclerView.Adapter<vendorfragmentlistRecycler.ViewHolder> {
    ...
    private vendorlistFragment pulse;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.vendoritem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent =  new Intent(context, vendorproposrequest.class);
    ...
    public vendorfragmentlistRecycler(List<sabaEventItem> items, Context context, vendorlistFragment pulse, sabaapp app) {
        this.items = items;
